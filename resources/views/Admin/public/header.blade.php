        ...
        <ul class="nav navbar-nav navbar-right top-menu top-right-menu">
            ...
            <li class="dropdown text-center">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    ...
                    <span class="username">管理员</span> <span class="caret"></span>
                </a>
                <ul class="dropdown-menu pro-menu fadeInUp animated" tabindex="5003" style="overflow: hidden; outline: none;">
                    <li><a href="profile.html"><i class="fa fa-briefcase"></i>首页</a></li>
                    <li><a href="#"><i class="fa fa-cog"></i>个人设置</a></li>
                    <li><a href="#"><i class="fa fa-bell"></i>消息<span class="label label-info pull-right mail-info">5</span></a></li>
